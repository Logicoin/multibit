...
public class ApplicationDataDirectoryLocator {
     ...
     * 
     * 1. See if there is a multilogic.properties in MultiLogic's current working
     ...
     * 
     * PC System.getenv("APPDATA")/MultiLogicInExecutableJar
     * 
     * e.g. C:/Documents and Settings/Administrator/Application Data/MultiLogicInExecutableJar
     * 
     * Mac System.getProperty("user.home")/Library/Application Support/MultiLogicInExecutableJar
     * 
     * e.g. /Users/jim/Library/Application Support/MultiLogicInExecutableJar
     * 
     * Linux System.getProperty("user.home")/MultiLogicInExecutableJar
     * 
     * e.g. /Users/jim/MultiLogicInExecutableJar
     */
    public String getApplicationDataDirectory() {
        ...
        if (multibitPropertiesFile.exists()) {
            ...
            if (operatingSystemName != null && operatingSystemName.startsWith("Windows")) {
                // Windows os
                applicationDataDirectory = System.getenv("APPDATA") + File.separator + "MultiLogic";
            } else {
                if (operatingSystemName != null && operatingSystemName.startsWith("Mac")) {
                    ...
                    if ( (new File("../../../../" + FileHandler.USER_PROPERTIES_FILE_NAME)).exists()) {
                        ...
                        applicationDataDirectory = System.getProperty("user.home") + "/Library/Application Support/MultiLogic";
                    }
                } else {
                    // treat as Linux/ unix variant
                    applicationDataDirectory = System.getProperty("user.home") + "/MultiLogic";
                }
            }
     ...
     * This is the directory into which MultiLogic was installed.
     * @throws IOException 
     * 
