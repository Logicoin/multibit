...
import com.google.logicoin.core.CoreTestUtils.BlockPair;
...
import static com.google.logicoin.core.Utils.toNanoCoins;
import static org.junit.Assert.*;
import static org.junit.Assert.assertEquals;

/**
 * This is a selection of the logicoinj wallet tests - mainly included 
 * to exercise the Wallet code every time the multibit tests are run.
 * 
 * The full wallet tests are in the logicoinj codebase.
 * 
 * @author jim
 *
 */
public class WalletTest {
    ...
    private Transaction sendMoneyToWallet(Wallet wallet, Transaction tx, AbstractBlockChain.NewBlockType type) throws IOException,
        ...
        if (type == null) {
            ...
            BlockPair bp = com.google.logicoin.core.CoreTestUtils.createFakeBlock(params, blockStore, tx);
    ...
    private Transaction sendMoneyToWallet(Wallet wallet, BigInteger value, Address toAddress, AbstractBlockChain.NewBlockType type)
        ...
        return sendMoneyToWallet(wallet, com.google.logicoin.core.CoreTestUtils.createFakeTx(params, value, toAddress), type);
    }

    private Transaction sendMoneyToWallet(BigInteger value, AbstractBlockChain.NewBlockType type) throws IOException,
            VerificationException {
        return sendMoneyToWallet(this.wallet, com.google.logicoin.core.CoreTestUtils.createFakeTx(params, value, myAddress), type);
    }
  ...
  @Test
   public void largeBalance() throws Exception {
    ...
    public void pending1() throws Exception {
        ...
        com.google.logicoin.core.CoreTestUtils.BlockPair fakeBlock = CoreTestUtils.createFakeBlock(params, blockStore, t1Copy);
